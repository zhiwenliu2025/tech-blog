    ...
    >
      <div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-3">
          ...
          <span class="font-mono text-xs text-slate-400 dark:text-slate-500">create.post</span>
            ...
            <div class="p-5">
              <div class="mb-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="mt-1 text-sm text-slate-400">检测到上次编辑的内容，是否恢复？</p>
                </div>
              </div>
