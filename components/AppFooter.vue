<template>
  <footer
    class="border-t border-gray-200 bg-white transition-colors duration-300 dark:border-gray-700 dark:bg-gray-800"
  >
        ...
        <div class="col-span-1 md:col-span-2">
          ...
          <div class="mt-4 flex space-x-4">
            <a
              ...
              aria-label="GitHub"
            >
              <Icon name="i-simple-icons-github" class="h-6 w-6" />
            </a>
            <a
              ...
              aria-label="Twitter"
            >
              <Icon name="i-simple-icons-twitter" class="h-6 w-6" />
            </a>
            <a
              ...
              aria-label="Email"
            >
              <Icon name="i-heroicons-envelope" class="h-6 w-6" />
            </a>
          </div>
        </div>
